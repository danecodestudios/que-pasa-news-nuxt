    ...
    <div class="container imagen-caja">
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <img class="img_posts" :src="imagenUno" alt="" />
        </div>
        <div class="col-md-2"></div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6">
          <div class="container tarjeta">
            ...
            <div class="card-body">
              <h1 class="card-title title">{{ primicia }}</h1>

              <div v-html="contenidoUno"></div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  async mounted() {
    try {
      ...
      this.primicia = res.data.destacados[1].titulo
      this.idUno = res.data.destacados[1].id
      this.contenidoUno = marked(res.data.destacados[1].descripcion)
      this.primiciasUno = res.data.destacados[1]
      this.imagenUno = res.data.destacados[1].imagen[0].url
